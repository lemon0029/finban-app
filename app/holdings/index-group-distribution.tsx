...
function IndexGroupDistributionChart({holdings}: { holdings: HoldingDTO[] }) {
    ...
    return (
        <Card className="flex flex-col gap-3 rounded-sm pb-3">
            <CardHeader className="items-center pb-0 px-4">
                ...
                <CardDescription>总共有 {holdings.length} 个产品，总金额 $234i</CardDescription>
                <CardAction>
...
export default IndexGroupDistributionChart
